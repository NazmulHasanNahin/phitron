...
const Blog = ({ blog , handleAddToBookmark}) => {
    ...
    const { title, cover_image, author_name, author_img, posted_date, reading_time, hashtag } = blog;
    return (
        <div className="mb-20">
            ...
            <div>
                <p className="text-[#6047EC] text-[18px] font-medium leading-normal underline underline-offset-auto decoration-solid decoration-skip-ink-none decoration-auto">
                    Mark as read
                </p>
